...
public class TestRunmode {
	...
	public static void main(String[] args) {
		Xls_Reader x = new Xls_Reader(System.getProperty("user.dir")+"\\src\\com\\core\\xls\\A suite.xlsx");
		System.out.println(isTestCaseRunnable(x,"TestCase_A1"));
		Xls_Reader x1 = new Xls_Reader(System.getProperty("user.dir")+"\\src\\com\\core\\xls\\B suite.xlsx");
